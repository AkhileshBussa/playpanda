...
export default function sitemap(): MetadataRoute.Sitemap {
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${SITE_URL}/kids-play-zone`, changeFrequency: "monthly", priority: 0.9 },
    { url: `${SITE_URL}/birthday-parties`, changeFrequency: "monthly", priority: 0.9 },
    { url: `${SITE_URL}/pricing`, changeFrequency: "monthly", priority: 0.85 },
  ...
  const areaRoutes: MetadataRoute.Sitemap = AREAS.map((a) => ({
    url: `${SITE_URL}/kids-play-zone/${a.slug}`,
    changeFrequency: "monthly",
    priority: 0.7,
  }));
